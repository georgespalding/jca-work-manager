...
public class WorkManagerBootstrap implements ResourceAdapter {
	private static final String CLASS_NAME = WorkManagerBootstrap.class.getName();
	...
	public XAResource[] getXAResources(ActivationSpec[] ass)
			throws ResourceException {
		log.entering(CLASS_NAME, "getXAResources",ass);
		log.exiting(CLASS_NAME, "getXAResources",null);
		return null;
	}
}
